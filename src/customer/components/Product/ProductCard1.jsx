  ...
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        ...
        <div className=" grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8 hover:shadow-lg transition-shadow duration-300">
          {data.map((product) => (
            <a key={product.id} href={product.href} className="group cursor-pointer border-3 border-gray-500">
              <img
                alt={product.title}
                src={product.image}
              ...
              <p className="mt-1 opacity-50 line-through">1000</p>
              
              <p className="mt-1 text-green-600 font-semibold">10%</p>
